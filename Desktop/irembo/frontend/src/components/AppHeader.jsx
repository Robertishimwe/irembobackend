...
export default function AppHeader() {
  ...
  const handleLogout = () => {
    ...
    api
      .post(`/auth/logout`, {
        _id: authenticated.user.payload._id,
      })
      .then((res) => {
  ...
  const renderMenu = (
    ...
    >
      ...
      <MenuItem onClick={handleRedirectToAdd}>Document</MenuItem>
      {authenticated.user.payload.role == "admin" ? (
        <MenuItem onClick={handleRedirectTocpanel}>Cpanel</MenuItem>
      ) : null}
